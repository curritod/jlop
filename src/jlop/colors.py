...
def set_colorcycle(name='default'):
    ...
    match name:
        ...
        case 'pc-88':
            ...
            color_cycle = ['0000db', '00b6db', '00db6d', 'ffb600', 'ff926d', 'db0000', 'dbdbdb', '000000']
        case 'coldwood':
    ...
    #Set color cycle
    #color_cycle = ['000000','2121ff','f03c79','ff50ff','7fff00','7fffff','ffff3f','ffffff']
...
#axes.prop_cycle: cycler('color',['000000','2121ff','f03c79','ff50ff','7fff00','7fffff','ffff3f','ffffff'])
